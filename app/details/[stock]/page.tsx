...
export default function Component({ params }: { params: { stock: string } }) {
  ...
  useEffect(() => {
    fetch(`http://172.20.10.6:3002/api/forecast/${params.stock}/name`, { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then(res => res.json())
      .then(data => {
        setName(data.name);
      });
    fetch(`http://172.20.10.6:3002/api/forecast/${params.stock}/daily`, { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then(res => res.json())
      .then(data => setDailyPrices(data));
    fetch(`http://172.20.10.6:3002/api/forecast/${params.stock}`, { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then(res => res.json())
      .then(data => setForecast(data));
    fetch(`http://172.20.10.6:3002/api/forecast/${params.stock}/QA`, { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then(res => res.json())
      .then(data => {
    ...
    <div className="flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="w-full max-w-4xl p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button onClick={() => {
            fetch(`http://172.20.10.6:3002/api/forecast/${params.stock}/QA`, {
              method: "POST",
              headers: {
