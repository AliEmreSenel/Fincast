...
export default function Home() {
  ...
  useEffect(() => {
    fetch("https://e709-78-211-10-235.ngrok-free.app/api/popular_stocks", { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch("https://e709-78-211-10-235.ngrok-free.app/api/forecast/list", { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then((res) => res.json())
  ...
  useEffect(() => {
    ...
    Promise.all(trendingStocks.map((ts) => {
      return fetch("https://e709-78-211-10-235.ngrok-free.app/api/forecast/" + ts, { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
        .then((res) => res.json())
    })).then((data) => {
      setForecasts(data)
    }).catch((err) => {
