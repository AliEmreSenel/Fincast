...
export default function Home() {
  ...
  useEffect(() => {
    fetch("http://172.20.10.7/api/popular_stocks", { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch("http://172.20.10.7/api/forecast/list", { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
      .then((res) => res.json())
  ...
  useEffect(() => {
    ...
    Promise.all(trendingStocks.map((ts) => {
      return fetch("http://172.20.10.7/api/forecast/" + ts, { method: "get", headers: new Headers({ "ngrok-skip-browser-warning": "true", }) })
        .then((res) => res.json())
    })).then((data) => {
      setForecasts(data)
    }).catch((err) => {
